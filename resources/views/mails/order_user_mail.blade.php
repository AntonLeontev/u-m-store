                    ...
                    <tr>
                        <td class="info-td" bgcolor="#ffffff">
                            <table class="table-165" cellpadding="0" cellspacing="0" width="100%" align="center">
                                <tr>
                                    <td class="new__title" style="font-family: 'Open Sans', sans-serif;">Спасибо за Ваш заказ!</td>
                                </tr>
                                <tr>
                                    <td class="new__yes" style="font-family: 'Open Sans', sans-serif;">Заказа принят и подтвержден</td>
                                </tr>
                                <tr>
                                    <td class="new__description" style="font-family: 'Open Sans', sans-serif;">
                                        Здравствуйте!<br>
{{--                                        @if(session()->has('order')), {{ session('order')['user_name'] }}@endif--}}
                                        Ваш заказ подтвержден и скоро будет выполнен. Вы получите уведомление в день доставки. Отслеживать статус заказа Вы можете в <a href="{{route('auth')}}" target="_blank">Личном кабинете</a>.
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <td class="padding__none">
                                                <table class="table-465 table-two" cellpadding="0" cellspacing="0" width="465" align="center">
                                                    <tr>
                                                        ...
                                                        <td class="table__sum table__allprice" style="font-family: 'Open Sans', sans-serif;">{{ $options->total }} ₽</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="table__sum" style="font-family: 'Open Sans', sans-serif;">Доставка</td>
                                                        <td class="table__sum table__allprice" style="font-family: 'Open Sans', sans-serif;">{{ $options->delivery_price_for_recipient }}₽</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
...
{{--                            </tr>--}}
                            ...
                            <tr>
                                ...
                                <td class="table__position" style="font-family: 'Open Sans', sans-serif;">{{ $options->firstname }}</td>
                            </tr>
                            <tr>
