...
<head>
	...
	<link rel="stylesheet" href="css/style.min.css?_v=20241230141750">
...
<body>
	<div class="wrapper">
		<header class="header">
			<div class="header__container">
				<a href="/" class="header__logo logo"><img src="img/logo.webp" alt="Logo"></a>
		...
		<main class="page">
			<section class="hero section-bottom">
				<picture>
					<source media="(min-width: 480px)" srcset="img/hero-dec.svg">
					<img src="img/hero-dec_m.svg" alt="Image" class="hero__dec">
				</picture>
				<div class="hero__container">
					...
					<div class="hero__img">
						<img src="img/hero-img.webp" alt="Image" class="ibg">
					</div>
				</div>
			</section>
					...
					<div class="benefits__items">
						<div class="benefit">
							<div class="benefit__header">
								<img src="img/benefits/01.webp" alt="Image">
						...
						<div class="benefit">
							<div class="benefit__header">
								<img src="img/benefits/02.webp" alt="Image">
								<strong>Мобильное приложение</strong>
							</div>
							<div class="benefit__body">
								<strong>Готовое мобильное приложение сразу</strong> с&nbsp;вашим инетрнет-магазином
							</div>
						</div>
						<div class="benefit">
							<div class="benefit__header">
								<img src="img/benefits/03.webp" alt="Image">
								<strong>Интернет-Эквайринг</strong>
							</div>
							<div class="benefit__body">
								Подключайте <strong>Интернет-эквайринг одним кликом</strong> и&nbsp;принимайте платежи для
								ИП, ООО и&nbsp;Самозанятых
							</div>
						</div>
					</div>
				</div>
				...
				<div class="cases__container">
					...
					<div class="cases__items">
						<div class="case d-flex">
							...
							<img src="img/cases/01/01.webp" alt="Image" class="case__img">
						</div>
						<div class="case d-flex">
							<div class="case__title">Косметика</div>
							<img src="img/cases/02/01.webp" alt="Image" class="case__img">
						</div>
						<div class="case d-flex">
							<div class="case__title">Флористика</div>
							<img src="img/cases/04/01-01.webp" alt="Image" class="case__img">
						</div>
						<div class="case">
							<div class="case__body">
							...
							<img src="img/cases/03/01.webp" alt="Image" class="case__img">
							<img src="img/cases/03/02-dec.svg" alt="Image" class="case__img-dec">
						</div>
						<div class="case d-flex">
							<div class="case__body">
							...
							<img src="img/cases/05/01.webp" alt="Image" class="case__img">
							<img src="img/cases/05/02-dec.svg" alt="Image" class="case__img-dec">
						</div>
					</div>
					<div class="cases__now now-start">
						<div class="now-start__wrapper">
							<img src="img/now/01.svg" alt="Image" class="now-start__dec">
							<div class="now-start__img">
								<img class="ibg" src="img/now/now-img.webp" alt="Image">
							</div>
				...
				<div class="how-work__container">
					...
					<div class="how-work__items">
						<div class="item-how-work">
							<img src="img/how/01-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/01.webp" alt="Image" class="ibg">
							</div>
						...
						<div class="item-how-work">
							<img src="img/how/02-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/02.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
								<div class="item-how-work__title">Создание первого магазина</div>
						...
						<div class="item-how-work">
							<img src="img/how/03-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/03.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
						...
						<div class="item-how-work">
							<img src="img/how/04-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/04.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
						...
						<div class="item-how-work">
							<!--                        <img src="img/how/07-dec.svg" alt="Image" class="item-how-work__dec">-->
							<div class="item-how-work__img">
								<img src="img/how/05.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
						...
						<div class="item-how-work">
							<img src="img/how/06-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/06.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
								<div class="item-how-work__title">Продавайте и&nbsp;зарабатывайте</div>
								<div class="item-how-work__text">Продавайте и&nbsp;получайте платежи, У нас уже подключена
									система интернет эквайринга и&nbsp;Юкассы
								</div>
							</div>
						</div>
						<div class="item-how-work">
							<img src="img/how/07-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/07.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
						...
						<div class="item-how-work">
							<img src="img/how/09-dec.svg" alt="Image" class="item-how-work__dec">
							<div class="item-how-work__img">
								<img src="img/how/09.webp" alt="Image" class="ibg">
							</div>
							<div class="item-how-work__body">
			...
			<section class="why section-bottom">
				<div class="why__container">
					...
					<div class="why__accent accent-block">
						<img src="img/accent-block-bg.svg" alt="Image" class="accent-block__bg">
						...
						<div class="accent-block__img">
							<img src="img/accent-block-img.webp" alt="Image" class="ibg">
						</div>
					</div>
					<div class="why__items">
						...
						<div class="item-why">
							<div class="item-why__body">
								...
								<div class="item-why__text">Наши партенры, возьмут на&nbsp;себя бугалтерию абсолютно
									бесплатно
								</div>
							</div>
						</div>
						<div class="item-why item-why_img">
							...
							<img src="img/accent-block-dec-2.webp" alt="Image" class="item-why__img">
						</div>
						<div class="item-why item-why_img">
							<div class="item-why__body">
								<div class="item-why__title">Интернет эквайринг</div>
								<div class="item-why__text">Вам не нужно обращаться к&nbsp;веб-студии: мы уже настроили
									связь
									между платформой и&nbsp;разными сервисами
								</div>
							</div>
							<img src="img/accent-block-dec-1.svg" alt="Image" class="item-why__img">
						</div>
						...
						<div class="item-why item-why_light" style="background:var(--accent);">
							<div class="item-why__body">
								<div class="item-why__title">Настраивайте SEO</div>
								<div class="item-why__text">Укажите title, description, заголовки Н1-Н3 и&nbsp;начните
									привлекать
									клиентов из&nbsp;поиска.
								</div>
							</div>
							...
							<div class="tariffs__slide swiper-slide">
								<div class="tariff">
									...
									<div class="tariff__footer">
										<a href="/auth" class="tariff__btn button">Попробовать бесплатно</a>
									</div>
								</div>
							</div>
							<div class="tariffs__slide swiper-slide">
				...
				<div class="create__container">
					<div class="now-start">
						<div class="now-start__wrapper">
							<img src="img/now/01.svg" alt="Image" class="now-start__dec">
							<div class="now-start__img">
								<img class="ibg" src="img/now/now-img_footer.webp" alt="Image">
							</div>
							<div class="now-start__content">
								<div class="now-start__title">создайте свой <br> интернет-магазин сейчас!</div>
								<div class="now-start__text">
			...
			<section class="try section-bottom">
				<div class="try__container">
					...
					<div class="try__text">Ваш бизнес начинается с&nbsp;сайта — запустите его за&nbsp;15 минут, без программистов и&nbsp;дизайнеров</div>
	...
	<script src="js/app.min.js?_v=20241230141750"></script>
</body>
