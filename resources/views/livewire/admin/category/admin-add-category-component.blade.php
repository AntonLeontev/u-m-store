        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" wire:submit.prevent="storeCategory">
                    ...
                    <div class="download-product__form-group">
                        <label for="parent-category" >Слаг</label>
                        <input type="text" placeholder="Имя категории" class="download-product__form-input form-control input-md" wire:model="slug"  required>
                    </div>
