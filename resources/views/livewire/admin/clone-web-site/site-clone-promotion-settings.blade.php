        ...
        <section class="profile">
            <div class="container">
                <div class="profile__inner">
                    <div class="profile__title active">Настройка списка акций</div>
                    <div class="profile__wrapper">
                        ...
                        <div class="set__inner">
                            ...
                            @if($uploaded_banners)
                                <div class="set__one">
                                    <div class="set__step">Загруженные изображения акций:</div>
                                        ...
                                        <form enctype="multipart/form-data" wire:submit.prevent="saveAllBanners">
                                            ...
                                            @foreach($uploaded_banners as $key=>$uploaded_banner)
                                                ...
                                                <div wire:key="uploaded_banner-field-{{ $uploaded_banner->id }}">
                                                    <div class="set__pos">
                                                        Изображение для акции {{$key+1}}:<span
                                ...
                                <div class="set__one">
                                    ...
                                    <div class="set__form" style="max-width: 550px; width: 100%">
                                        <form enctype="multipart/form-data" wire:submit.prevent="saveSliderSettings">
                                            ...
                                            {{-- Загрузка баннеров. --}}
                                            <div class="set__pos">
                                                Изображение для акции:<span class="label__partner"></span></div>
                                            <div>
