...
<div class="container">
    <div class="user-content">
        ...
        <p>
            <strong>Общество с ограниченной ответственностью интернет-компания «Умные решения» (сервис United
                Market)</strong>,в лице генерального
            директора Дмитриенко Андрея Андреевича, действующего на основании Устава, именуемое в дальнейшем «Исполнитель»,
            с одной
            стороны и <strong>Общество с ограниченной ответственностью</strong> _____________________, в лице генерального
            директора
            ___________________________, действующего на основании Устава, именуемое в дальнейшем
            <strong>«Заказчик»</strong>, с другой стороны,
            совместно именуемые <strong>«Стороны»</strong>, а по отдельности <strong>«Сторона»</strong>, руководствуясь
        ...
        <div>
            ...
            друг от
            друга в процессе осуществления сотрудничества, согласно условиям данного договора.<br />
        ...
        <div>
            ...
            привлеченного
            Исполнителем посредством продвижения интернет-платформы Исполнителя.<br />
            2.2. Заказчик принимает на себя обязательства по оказанию Услуг и поставки Товаров Клиентам Исполнителя, на
            условиях и
            за вознаграждение, предусмотренных настоящим Договором.<br />
            2.3. Услуги считаются выполненными после фактического совершения сделки между Заказчиком и Клиентом.<br />
            2.4. Акцепт Договора производится Заказчиком путем подписания настоящего Договора.<br />
            2.5. Предметом настоящего договора является взаимное сотрудничество Сторон с целью расширения сбыта продукции и
            услуг, а
            также увеличения клиентской базы.<br />
        ...
        <div>
            ...
            которые стали
            известны в процессе совместной деятельности.<br />
            3.2. Стороны обязуются рекламировать деятельность друг друга в форме и объёмах, согласованных друг с другом.<br />
            3.3. Стороны обязуются передавать друг другу все материалы, необходимые для рекламы и продажи своих товаров,
            каталоги,
            проспекты, чертежи, техническую документацию, фотографии, слайды, рекламные образцы и т. д.<br />
            3.4. Стороны имеют право не разглашать информацию о своих Клиентах, кроме тех случаев, когда Клиент привлечён
            Исполнителем Заказчику или Заказчиком Исполнителю.<br />
            3.5. Исполнитель обязуется:<br />

            <div class="user-content__inner-list">
                3.5.1. Разместить предложения о продаже Товаров и/или Услуг Заказчика в интернет-магазине по адресу
                <a href="https://onionmarket.ru">https://onionmarket.ru</a>.<br />

                3.5.2. Принимать меры по поиску и привлечению потенциальных Клиентов Заказчику, юридических или физических лиц,
                и
                предоставить им возможность оформлять заявки на услуги, представляемые Заказчиком.<br />
                3.5.3. Обеспечить регулярное обновление информации об услугах Заказчика; информация должна быть получена от
                Заказчика
                посредством письма, направленного на почту <a href="partner@united-market.ru">partner@united-market.ru</a>.
                3.5.4. Нести ответственность за искажение на Интернет-ресурсах материалов, изображений и текстов, далее
                «Материалов»,
                переданных для использования согласно данному Договору.<br />
                ...
                материалы,
                полученные от Заказчика согласно данному Договору.<br />
                ...
                3-х
                календарных дней с момента их появления или заблаговременно.<br />
                3.5.8. Своевременно принимать и обрабатывать заказы.<br />
            </div>

            3.6. Исполнитель имеет право:<br />

            <div class="user-content__inner-list">
                3.6.1. Для учёта произведённых им по настоящему Договору действий формировать базу данных о Клиентах,
                привлечённых им
                для сотрудничества с Заказчиком.<br />
                3.6.2. Получать информацию от Заказчика и/или Клиента о прохождении сделки Заказчика и Клиента, привлечённого
                Исполнителем.<br />
            </div>

            3.7. Заказчик обязуется:<br />

            <div class="user-content__inner-list">
                3.7.1. Предоставлять услуги Клиентам, привлеченным Исполнителем, точно так же, как и прочим клиентам Заказчика.<br />
                3.7.2. Предоставлять Исполнителю всю необходимую для оказания Услуг информацию и документы.<br />
                3.7.3. Обеспечивать процедуру оформления Сделки, выполнение Сделки, в некоторых случаях процедуру отмены Сделки
                Клиентом, поддержку других процедур.<br />
                3.7.4. Обеспечить контроль над учётом Клиентов, привлеченных Исполнителем.<br />
                3.7.5. Сообщать Исполнителю о любых изменениях, которые могу повлиять на работу и исполнение заказов, по
                электронной
                почте или другим способом не менее, чем за 5 (пять) дней до вступления в силу соответствующих изменений.<br />
                3.7.6. Выплачивать/оставлять Исполнителю вознаграждение в порядке и размерах, предусмотренных настоящим
                Договором.<br />
                3.7.7. Предоставлять по требованию Исполнителя информацию о состоянии сделки с привлечённым им Клиентом.<br />
                3.7.8. Разместить в своем магазине, либо на входе в магазин логотип Исполнителя на свое усмотрение: наклейка,
                плакат,
                вывеска, баннер и прочее, на весь период сотрудничества.<br />
            </div>

            3.8. Заказчик имеет право:<br />

            <div class="user-content__inner-list">
                3.8.1. Отказаться от исполнения договора в случае, если Клиент отказывается от услуг.<br />
            </div>
        </div>
        ...
        <h3>5. Порядок изменения и расторжения договора</h3>

        <div>
            5.1. Изменение, дополнение и расторжение данного договора допускаются по взаимному согласию Сторон, а в случаях,
            установленных законом или данным договором, данный договор может быть прекращен или расторгнут в ином порядке.<br />
        ...
        <div>
            ...
            расчетного
            счета Исполнителя в пользу Заказчика в установленном в п.6.3 объёме.<br />
        ...
        <div>
            ...
            несут
            ответственность в соответствие с действующим законодательством РФ.<br />
            ...
            Исполнителю, сверх
            предусмотренного настоящим Договором вознаграждения, штраф в размере 20% от суммы сделки (контракта).<br />
            ...
            то
            Заказчик обязуется выплатить штраф в размере полной стоимости заказа +20% от стоимости заказа.<br />
        ...
        <h3>8. Форс-мажорные обстоятельства</h3>
        ...
        <div>
            ...
            государственных органов нормативного характера, создающие невозможность выполнения обязательств по настоящему договору.<br />
            8.2. Сторона, для которой стало невозможным исполнение обязательств в результате наступления ФМО, должна в течение 2
            (двух) рабочих дней с момента наступления ФМО уведомить в письменном виде (письмо на почту <a href="partner@united-market.ru">partner@united-market.ru</a>)
            другую Сторону о начале, предполагаемом времени действия (длительности) и прекращении указанных обстоятельств.<br />
            8.3. Уведомление о наличии и продолжительности ФМО должно быть подтверждено соответствующим сочтенным контрагентом
            достоверным источником.<br />
            8.4. В случае наступления оговоренных выше ФМО и при условии надлежащего сообщения о них, срок исполнения обязательств
            по настоящему договору продлевается на период, соразмерный сроку действия ФМО и разумному сроку их последствий.<br />
        ...
        <h3>9. Положения о конфиденциальности</h3>
        ...
        <div>
            ...
            разрешаются путем переговоров.<br />
        ...
        <div>
            ...
            условиям договора, как на основание считать его незаключенным или недействительным.<br />
            ...
            установить, от кого исходило сообщение и кому оно адресовано.<br />
            ...
            разумно необходимо в целях выполнения своих обязательств по настоящему Договору.<br />
            11.10. В том, что не предусмотрено настоящим Договором, стороны руководствуются действующим Законодательством РФ.
            11.11. Товары и Услуги Заказчика размещаются Исполнителем по адресу <a href="https://onionmarket.ru">https://onionmarket.ru</a> в
            ...
            Заказчика, размещенного по адресу <a href="https://onionmarket.ru">https://onionmarket.ru</a> , несет Исполнитель.<br />
            11.13. Расходы, связанные с хранением, обработкой и упаковкой Товара несет Заказчик.<br />
            11.14. Расходы, связанные с разработкой и изготовлением логотипа, несет Исполнитель.<br />
            11.15. Заказчик гарантирует, что цены на Товары и Услуги, предоставленные Исполнителю, ниже цен на аналогичные товары,
            реализуемые Заказчиком самостоятельно путем размещения предложений на сайтах в сети Интернет и социальных сетях.<br />
            11.16. Заказчик гарантирует, что качество Товара соответствует требованиям к качеству и безопасности Товара,
            установленным законодательством Российской Федерации.
        </div>

        <h3>12. Адреса, реквизиты и подписи сторон</h3>

        <table class="user-content__table" cellpadding="0" cellspacing="0">
            <thead >
            <tr>
                <td>Исполнитель:</td>
            ...
            <tr>
                <td>
                    ООО интернет-компания «Умные решения» (сервис Onion Market)<br />
                    Юридический адрес: 185035, Республика Карелия, г. Петрозаводск, ул. Гоголя (Центр Р-Н), д. 58, офис 6<br />
                    ИНН: 1001292559<br />
                    ОГРН: 1151001000820<br />
                    КПП: 100101001<br />
                    ...
                    Расч.счет: 40702810732460000526<br />


                    +7 999 333 54 01<br />
                    partner@united-market.ru<br />

                    <div style="margin-bottom: 60px;"></div>

                    <div>______________ / Дмитриенко А.А./</div>

                    <img class="user-content__img-print" src="./print.png" alt="#">
                </td>

                <td>
                    <div style="margin-bottom: 60px;"></div>

                    <div style="margin-top: auto;">___________ /        /</div>
                </td>
            </tr>
            </tbody>
        </table>
