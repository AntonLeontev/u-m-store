                    ...
                    <div class="profile__wrapper">
                        ...
                        <div class="profile__bigboxing">
                            ...
                            <div class="create-text" style="background: rgba(191, 198, 224, .4); padding: 42px 75px;">
								...
								<p>Обратите внимание, что при использовании конструктора интернет-магазинов <strong>U-M.Store</strong> строго запрещено создавать магазины, предлагающие следующие товары и услуги, запрещенные законодательством Российской Федерации:</p>
