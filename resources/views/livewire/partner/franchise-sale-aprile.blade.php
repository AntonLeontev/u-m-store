                ...
                <div class="franchise__container">
                    <div class="franchise__text-wrapper">
                        ...
                        <p class="franchise__desc">
                            Используй уникальную цифровую экосистему на технологии блокчейн в своём бизнесе
                        </p>
                    </div>
...
{{--                        <a href="{{asset('pdf/franchise/Франшиза UM__.pdf')}}" class="franchise__button franchise__button_blue">Скачать брендбук</a>--}}
        ...
        <section class="franchise__table">
            ...
            <ul class="franchise__table-list">
                ...
                <li class="franchise__table-item">
                    <span class="franchise__table-elem franchise__elem-text">Комиссия с продаж на платформе</span>
...
{{--           </li>--}}
                <li class="franchise__table-item">
                    ...
                    <span class="franchise__table-elem franchise__table-elem--green">от 40 000
                        &#8381; товаром</span>
                    <span class="franchise__table-elem franchise__table-elem--green">от 100 000
                        &#8381;</span>
                </li>
            </ul>
            <p class="franchise__text">* Генеральный партнер имеет гарантию сотрудничества, его нельзя поменять. Часть обязательств за Партнера берет на себя UNITED MARKET, поэтому, если UNITED MARKET считает данного Партнера недобросовестным, например, вовремя не наполняет сайт, не дает гарантию качества на свой продукт, то UNITED MARKET в праве выбрать другого Партнера</p>
        </section>
        ...
        <div class="container">
            <div class="franchise__wrapper" style="background: #3657C8; border-radius: 20px;">
                ...
                @include('livewire.includes.franchise-sale-aprile-questions-form')
            </div>
        </div>
    </div>
</div>
...
<div class="franchise-um-popup franchise-um-popup-gp fb-none" wire:ignore.self>
    <button class="franchise-um-popup__close">
        <span class="visually-hidden">Закрыть</span>
        <i class="icon-um-city-close"></i>
    </button>
    ...
    @include('livewire.includes.franchise-sale-aprile-general-partner-form')
</div>

<div class="franchise-um-popup franchise-um-popup-p fb-none" wire:ignore.self>
    <button class="franchise-um-popup__close">
        <span class="visually-hidden">Закрыть</span>
        <i class="icon-um-city-close"></i>
    </button>
    ...
    <ul class="franchise-um-popup__list-menu">
        ...
        <li class="franchise-um-popup__form" wire:ignore.self data-tabs-target="franchise-ooo">
            @include('livewire.includes.franchise-sale-aprile-ooo-form')
        </li>
        <li class="franchise-um-popup__item-menu" data-tabs-path="franchise-ip">ИП</li>
        <li class="franchise-um-popup__form" wire:ignore.self data-tabs-target="franchise-ip">
            @include('livewire.includes.franchise-sale-aprile-ip-form')
        </li>
        <li class="franchise-um-popup__item-menu" data-tabs-path="franchise-self">Самозанятый</li>
        <li class="franchise-um-popup__form" wire:ignore.self data-tabs-target="franchise-self">
            @include('livewire.includes.franchise-sale-aprile-self-employed-form')
        </li>
    </ul>
</div>
</div>

<div class="franchise-um-popup franchise-um-popup__sendgood">
    <button class="franchise-um-popup__close">
        <span class="visually-hidden">Закрыть</span>
        <i class="icon-um-city-close"></i>
    </button>
    <p class="franchise-um-popup__sendgood-text">Спасибо! Скоро наши менеджеры свяжутся с вами</p>
</div>
