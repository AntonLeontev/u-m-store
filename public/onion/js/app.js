(() => {
    ...
    function initSliders() {
        if (document.querySelector(".tariffs__body")) {
            new Swiper(".tariffs__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        if (document.querySelector(".premium-slider")) {
    ...
    let options = {
        strings: [ "Создайте <span>интернет-магазин за 15 минут</span>", "Продавайте <span>товары на всех маркетплейсах</span>", "Станьте <span>первым на нашем маркетплейсе Onion Market</span>" ],
        typeSpeed: 90,
        loop: true,
        backDelay: 500,
        startDelay: 1e3
    };
    new i(".hero__title strong", options);
    window["FLS"] = false;
    menuInit();
    tabs();
    pageNavigation();
