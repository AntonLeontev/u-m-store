...
class CreateCloneSlidersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clone_sliders', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('image')->nullable()->comment('Email');
    ...
    {
        Schema::dropIfExists('clone_sliders');
    }
}
