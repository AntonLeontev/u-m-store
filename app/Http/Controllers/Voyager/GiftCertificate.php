...
class GiftCertificate extends VoyagerBaseController
{
    ...
    {
        if ($request->slug == null and $request->full_url == null) ;
        {
            $slug = Str::random(40);
            $full_url = 'https://unitedmarket.org?certificate=' . $slug;
            $request->request->add(['full_url' => $full_url, 'slug' => $slug]);
        }
        return $request;
    }
